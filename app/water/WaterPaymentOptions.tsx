...
// Dummy UPI logos. Replace with your actual images!
const upiApps = [
...
export default function WaterPaymentOptions() {
  const router = useRouter();
  const params = useLocalSearchParams();
  const [selected, setSelected] = useState("merchant_upi");
  const [selectedUpi, setSelectedUpi] = useState(null);
  const AIRTEL = require("../../assets/water/blr.png");

  // Demo: Only merchant UPI enables "Proceed To Pay"
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.boardBox}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.boardLabel}>{params.boardName}</Text>
            <Text style={styles.boardSub}>Water Bill</Text>
          </View>
      ...
      <View style={styles.footerBar}>
        ...
        <TouchableOpacity
          ...
          disabled={!canProceed}
          onPress={() => canProceed && router.push("/recharge/RechargeSuccess")} // Adjust route as needed
        >
          <Text style={[
            styles.footerBtnTxt,
